...
kill_process_by_script("defoult_with_time(A).py")
kill_process_by_script("defoult_with_time(B).py")
kill_process_by_script("defoult_with_time(C).py")
kill_process_by_script("defoult_with_time(D).py")
