    ...
    try:
        ...
        while True:
            ...
            for filename in bmp_files:
                ...
                if 8000 < white_pixel_count < 10000:
                    grade = '180+'
                    command = '16|'
                try:
                    arduino.write(command.encode())
...
if __name__ == '__main__':
    input_folder = r":\Kesyu_250524_4_Belts\Images\Con_1_Images"
    ranges_file = r"D:\Keya Work\360\wate\value.txt"
    timing_file = r"D:\Keya Work\360\wate\4(A)-time.txt"
    com_port_file_path = r"D:\Keya Work\360\wate\com_port(a).txt"
