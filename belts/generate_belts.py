...
input_folder = r"D:\\Kesyu_250524_4_Belts\\Images\\Con_{num}_Images"
timing_file_path = r"D:\\4_belt_main\\4_belt\\time\\4({letter_upper})-time.txt"
com_file_path = r"D:\\4_belt_main\\4_belt\\comport info\\comport({letter_lower}).txt"
com_port_file_path = r"D:\\4_belt_main\\4_belt\\Test_checkup\\com_port({letter_lower}).txt"
...
output_dir = r"d:\Keya Work\360\belts"
...
for i, letter in enumerate(letters):
    ...
    with open(os.path.join(output_dir, f"Belt({letter}).py"), "w") as f:
        f.write(content)

print("Generated 15 belt scripts successfully.")
